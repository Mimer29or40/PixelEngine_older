...
public class ConnectionHistory
{
    ...
    ArrayList<Integer> innovationNumbers = new ArrayList<>();//the innovation Numbers from the connections of the genome which first had this mutation
    ...
    ConnectionHistory(int from, int to, int inno, ArrayList<Integer> innovationNos)
    {
        ...
        innovationNumbers.addAll(innovationNos);
    }
