...
public class Genome
{
    public ArrayList<ConnectionGene> genes    = new ArrayList<>();//a list of connections between nodes which represent the NN
    public ArrayList<Node>           nodes    = new ArrayList<>();//list of nodes
    public int                       inputs;
    public int                       outputs;
    public int                       layers   = 2;
