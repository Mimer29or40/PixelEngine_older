...
public class AABB implements Printable
{
    ...
    {
        return Util.close(getLeft(), rect.getLeft(), opt_tolerance) &&
               Util.close(getBottom(), rect.getBottom(), opt_tolerance) &&
               Util.close(getRight(), rect.getRight(), opt_tolerance) &&
               Util.close(getTop(), rect.getTop(), opt_tolerance);
    }
